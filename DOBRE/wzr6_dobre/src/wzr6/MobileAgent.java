...
// ----------------------------------------
   int dlugosc_pauzy = 5;  // długość przerwy w animacji w [ms]
   ...
   UczenieZeWzm uzw = new UczenieZeWzm(typ_strategii);    // obiekt uczenia ze wzmocnieniem
...
// ------------------------
	...
	if (msg2!=null)
        ...
        msg3.setContent( "Witam! Jestem agentem " + this.getLocalName() +  " z kontenera " + destination.getName());
        ...
        msg_o_strat.setConversationId("Infor_o_strategii");
        ...
        addBehaviour(new CyclicBehaviour(this) // oczekiwanie na wiadomosc o utworzeniu innego agenta
	{
	    public void action() {
                ...
                numer_stanu++;
                MessageTemplate mt = MessageTemplate.MatchConversationId("Infor_o_utworzeniu");
	    ...
	    public void action() {
                ...
                MessageTemplate mt = MessageTemplate.and(
                        MessageTemplate.MatchConversationId("Infor_o_strategii"),
	    ...
	    public void action() {
                ...
                if (met_uczenia == UCZENIE_ZE_WZMOCNIENIEM)
                {
                    if (uzw.numer_epizodu < maks_liczba_epizodow)
                    {
                        ...
                        if (System.currentTimeMillis()-czas < 2016)
                        {
                            ...
                            String tekst = new String("uczeeeenie: śr nagroda po "+ag.liczba_epizodow_oceny+" epizodach = "+ocena);
	    ...
	    public void action() {
                ...
                if (msg!=null)
                {
                    ...
                    else                             // jeśli informacja o stanie innego agenta
                    {
                        ...
                        uzw.liczba_symul_agentow = liczba_agentow;

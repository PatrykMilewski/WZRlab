...
public class AlgGenetyczny {
  int liczba_rozw = 70;               // liczba rozwiązań w populacji ........................................................ TO NALEŻY USTAWIĆ
  ...
  double wsp_selekcji = 1;            // współczynnik nacisku selekcyjnego: im większy, tym więcej kopii lepszych kosztem gorszych ..... TO NALEŻY USTAWIĆ
  int czy_max_przechodzi = 0;         // czy najlepsze rozwiązanie przechodzi do następnego pokolenia bez zmian .............. TO NALEŻY USTAWIĆ

  int liczba_epizodow_oceny = 130;     // liczba epizodów (przejść labiryntu), na podstawie których obliczana jest ocena ..... TO NALEŻY USTAWIĆ
  ...
  File plik = new File("ag-log.txt");
  FileWriter fos;// = new FileOutputStream("test.txt");

  AlgGenetyczny()
  {
      System.out.println("konstr AlgGenetyczny - wersja h (2017/18)");

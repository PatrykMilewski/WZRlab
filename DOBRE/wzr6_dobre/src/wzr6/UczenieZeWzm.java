...
public class UczenieZeWzm {
    ...
    double epsylon = 0.3;             // wspolczynnik eksploracji podczas uczenia ..... TO NALEŻY USTAWIĆ
    ...
    int liczba_symul_agentow = 1;     // liczba agentów symulowanych podczas uczenia == liczbie działających agentów
    ...
    {
        System.out.println("UczenieZeWzmocnieniem - wersja g");
    ...
    void epizod_uczenia_Qlearning()
    {
        ...
        while ((stan.k != sr.liczba_kolumn-1)&&(nr_kroku < liczba_krokow_max)&&(nagroda <= 0))
        {
            ...
            int nr_akcji_wyb = nr_akcji_Qmax;
            
            if (eksploracja) {
                nr_akcji_wyb = new Random().nextInt(5);
            } 
            ...
            double a = 0.3;
            double y = Qmax;
             Q[stan.w][stan.k][nr_akcji_wyb] = (float) (Q[stan.w][stan.k][nr_akcji_wyb] + a*(r + y - Q[stan.w][stan.k][nr_akcji_wyb]));
             
         //    System.out.println(Q[stan.w][stan.k][nr_akcji_wyb]);
            //...................................................
            //...................................................
            //...................................................
            //...................................................

	...
	int       nCmdShow)
{
	...
	okno = CreateWindow(nazwa_klasy, "WZR-lab 2017/18 temat 2 (Nawigacja obl.), wersja h", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
		100, 100, 1200, 750, NULL, NULL, hInstance, NULL);
